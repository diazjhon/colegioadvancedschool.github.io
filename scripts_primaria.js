...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showFotos() {
        ...
        dynamicContent.innerHTML = `
            <img src="imagenes/primaria1.jpg" alt="Foto 1">
            <img src="imagenes/primaria2.jpg" alt="Foto 2">
        `;
    }
    ...
    function showVideos() {
        ...
        dynamicContent.innerHTML = `
            <video controls>
                <source src="videos/primaria5.mp4" type="video/mp4">
                Tu navegador no soporta el elemento de video.
            </video>
            <video controls>
                <source src="videos/primaria6.mp4" type="video/mp4">
                Tu navegador no soporta el elemento de video.
            </video>
        `;
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const imagenes = [
        'imagenes/primaria3.jpg',
        'imagenes/primaria4.jpg',
        'imagenes/primaria5.jpg',
        'imagenes/primaria6.jpg'
    ];
