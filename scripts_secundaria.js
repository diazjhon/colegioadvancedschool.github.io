...
/*Sección de secundaria-Matricula */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showFotos() {
        ...
        dynamicContent.innerHTML = `
            <img src="imagenes/secundaria1.jpg" alt="Foto 1">
            <img src="imagenes/secundaria2.jpg" alt="Foto 2">
        `;
    }
    ...
    function showVideos() {
        ...
        dynamicContent.innerHTML = `
            <video controls>
                <source src="videos/secundaria4.mp4" type="video/mp4">
                Tu navegador no soporta el elemento de video.
            </video>
            <video controls>
                <source src="videos/secundaria5.mp4" type="video/mp4">
                Tu navegador no soporta el elemento de video.
            </video>
        `;
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const imagenes = [
        'imagenes/secundaria7.jpg',
        'imagenes/secundaria4.jpg',
        'imagenes/secundaria5.jpg',
        'imagenes/secundaria8.jpg'
    ];
